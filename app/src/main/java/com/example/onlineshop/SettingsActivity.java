...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo()
    {
        ...
        Toast.makeText(SettingsActivity.this, "Informacje zaktualizowane pomyślnie.", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    private void userInfoSaved()
    {
        ...
        {
            Toast.makeText(this, "Podaj swój adres.", Toast.LENGTH_SHORT).show();
        }
    ...
    private void uploadImage() {
        ...
        progressDialog.setTitle("Zaktualizauj profil");
        progressDialog.setMessage("Proszę czekać, aktualizujemy Twoje informacje");
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task)
                        {
                            if (task.isSuccessful())
                            {
                                ...
                                startActivity(new Intent(SettingsActivity.this, HomeActivity.class));
                                Toast.makeText(SettingsActivity.this, "Aktualizacja zakończona pomyślnie.", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                            else
                            {
