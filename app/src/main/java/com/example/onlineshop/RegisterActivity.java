    ...
    private void ValidatePhoneNumber(String name, final String phone, String password) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (!(snapshot.child("Users").child(phone).exists()))
                {
                    ...
                    RootRef.child("Users").child(phone).updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            {
                                Toast.makeText(RegisterActivity.this,"Twoje konto zostało założone!",Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                                ...
                                loadingBar.dismiss();
                                Toast.makeText(RegisterActivity.this,"Bład, spróbuj ponownie!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                ...
                {
                    Toast.makeText(RegisterActivity.this,"Ten " + phone + " numer już istnieje w bazie.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                    Toast.makeText(RegisterActivity.this,"Spróbuj użyć innego numeru.", Toast.LENGTH_SHORT).show();
